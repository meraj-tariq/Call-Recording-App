...
const Home = lazy(() => import('../../views/Recorder/'))
const Login = lazy(() => import('../../views/Authentication/Login'))
const Error = lazy(() => import('../../views/Error'))
const DashboardApp = lazy(() => import('../../views/Dashboard/'))
...
const Routes = [
  ...
  {
    path: '/add-user',
    element: <DashboardApp /> //admin
  },
  {
    path: '/admin-portal',
    element: <UserListApp /> // admin
  },
  {
    path: '/activitylogs',
    element: <ActivityApp /> // activitylogs
  },
  {
    path: '/addRecord',
